<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
		...
		<!-- main 외  페이지 전용 -->
		<link href="<%=request.getContextPath() %>/resources/assets/css/custom-circle-header.css" rel="stylesheet" />
		...
		<link rel="apple-touch-icon" sizes="72x72" href="<%=request.getContextPath() %>/resources/temp/assetsimg/favicons/apple-touch-icon-72x72.png">
		<link rel="apple-touch-icon" sizes="114x114" href="<%=request.getContextPath() %>/resources/temp/assetsimg/favicons/apple-touch-icon-114x114.png">
