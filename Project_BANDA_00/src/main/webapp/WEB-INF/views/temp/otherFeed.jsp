        ...
        <!-- 개인정보 -->
         ...
         <div class="user-info">
          <div class="image">
            ...
            <img style = "height:121px" src="<%=request.getContextPath() %>/resources/images/filemanager/account/<%=vo.getId()%>/profile.jpg" class="img-responsive img-circle" alt="User" onerror="this.src = '<%=request.getContextPath() %>/resources/images/logo_profile.png'">
         ...
         <div class="row" style = "float:left;display:block" id = "first">
          ...
          <!-- 좋아요 -->
		        <div style = "float:left;width:20%;margin-left:3%;margin-top: -1%;">
			 	 ...
			 	 <a href = "#" style = "color:rgb(5,203,149);margin-left:5%;" id = "feed_follow"></a>
			 	</div>
